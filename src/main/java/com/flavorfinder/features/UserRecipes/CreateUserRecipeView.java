...
public class CreateUserRecipeView extends View {
    private CreateUserRecipeController controller;
    ...
    public void setController(CreateUserRecipeController controller) {
